# BIOMD0000000514: MODEL1401310001
...
`pip install git+https://github.com/biomodels/BIOMD0000000514.git`

To install a specific version (in this example, from the 2014-09-16 BioModels release)

`pip install git+https://github.com/biomodels/BIOMD0000000514.git@20140916`

## Usage

Importing the model package.

`import BIOMD0000000514 as model`
...
and its subsequent utilizing reactions. This model correspond to Model B of
the paper.
